...
create table Materia (id integer not null, anioEnCarrera integer not null, docente varchar(255), hola integer not null, nombre varchar(255), promocionable bit, carrera_id integer, primary key (id)) engine=InnoDB
